...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
        ...
        System.out.println(Utilitor.testString("View"));
    ...
    static void work02Person() {
        Person p1 = new Person("Kittikan", "Weelmek");
        Person p2 = new Person("King", "Jingjuay");
        Person p3 = new Person("Mama", "Slayer");
        ...
        p2.setFirstname("Tony");
        p2.setLastname("Starkkkk");
    ...
    static void work03Account() {
        Person p1 = new Person("Kittikan", "Weelmek");
        Person p2 = new Person("King", "Jingjuay");
        Person p3 = new Person("Hajime", "Hinata");
